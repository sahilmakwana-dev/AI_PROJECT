...
<div class="space-y-8 animate-[fadeIn_0.5s_ease-out]">
	<div class="flex flex-col sm:flex-row sm:items-center justify-between gap-4">
		...
		<a href="/teacher/courses/new" class="px-5 py-2.5 bg-gradient-to-r from-emerald-500 to-teal-500 text-white font-medium rounded-xl hover:scale-105 transition-transform flex items-center justify-center gap-2 shadow-lg shadow-emerald-500/20 shrink-0 w-full sm:w-auto">
